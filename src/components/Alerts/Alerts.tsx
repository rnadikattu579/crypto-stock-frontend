      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Get notified when assets reach your target prices</p>
          </div>
          <button
        ...
        {triggeredAlerts.length > 0 && (
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Triggered Alerts</h2>
            <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-600 font-medium mt-1">✓ Triggered</p>
                    </div>
                  </div>
                  <button
                    onClick={() => handleDeleteAlert(alert.id)}
        ...
        {alerts.length === 0 && (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Create your first price alert to get notified</p>
            <button
              onClick={() => setShowModal(true)}
