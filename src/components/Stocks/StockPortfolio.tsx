            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`p-2 rounded transition-colors ${viewMode === 'list' ? 'bg-white shadow-sm text-indigo-600' : 'text-gray-600 hover:text-gray-900'}`}
                  title="List View"
                >
                ...
                <button
                  ...
                  className={`p-2 rounded transition-colors ${viewMode === 'grid' ? 'bg-white shadow-sm text-indigo-600' : 'text-gray-600 hover:text-gray-900'}`}
                  title="Grid View"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                  {filteredAndSortedAssets.map((asset) => {
                    ...
                    return (
                      <div
                        key={asset.asset_id}
                        className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl shadow-md hover:shadow-xl transition-all p-6 border border-indigo-100"
                      >
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">{asset.quantity.toFixed(4)} shares</p>
                            </div>
                          </div>
                          <button
                            onClick={() => handleDeleteClick(asset.asset_id)}
